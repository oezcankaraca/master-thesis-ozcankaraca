...
public class SuperPeer {
    ...
    /**
     * Calculate for configuration time of network charactetistics
     * 
     * @param numberOfPeers The number of peers
     * @return The time for number of peers
     */
    static int calculateWaitTime(int numberOfPeers) {
        // Define base values
        int basePeer = 6;
        int baseTime = 50000; 
        int slope = 15000; 

        // Calculate the wait time based on the number of peers
        int waitTime = baseTime + (numberOfPeers - basePeer) * slope;
    ...
    public static void main(String[] args) throws Exception {
        ...
        Thread.sleep(calculateWaitTime(numberOfPeers));
 
        // Validation of the network characteristics for connections
